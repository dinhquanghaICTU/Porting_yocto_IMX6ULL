...
#ifndef CONFIG_PROC_DEBUG
static inline bool rtw_fwdl_test_trigger_chksum_fail(void)
{
	return _FALSE;
}

static inline bool rtw_fwdl_test_trigger_wintint_rdy_fail(void)
{
	return _FALSE;
}

static inline bool rtw_del_rx_ampdu_test_trigger_no_tx_fail(void)
{
	return _FALSE;
}

static inline u32 rtw_get_wait_hiq_empty_ms(void)
{
	return 0;
}

static inline void rtw_sta_linking_test_set_start(void)
{
}

static inline bool rtw_sta_linking_test_wait_done(void)
{
	return _TRUE;
}

static inline bool rtw_sta_linking_test_force_fail(void)
{
	return _FALSE;
}

static inline u16 rtw_ap_linking_test_force_auth_fail(void)
{
	return 0;
}

static inline u16 rtw_ap_linking_test_force_asoc_fail(void)
{
	return 0;
}
#endif
