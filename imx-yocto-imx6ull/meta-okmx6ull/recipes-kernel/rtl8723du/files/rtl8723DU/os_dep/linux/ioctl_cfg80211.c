...
{
	cfg80211_rtw_mgmt_frame_register(wiphy, wdev, IEEE80211_STYPE_AUTH,
...
/*
 * Kernels >= 5.10 validate vendor command policies during wiphy_register().
 * This legacy Realtek vendor extension table does not provide those policies,
 * so keep basic cfg80211 registration working and leave Android vendor commands
 * disabled on newer kernels.
 */
